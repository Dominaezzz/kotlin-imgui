...
kotlin {
	...
	for ((jvmTarget, osFamily, osArch) in jvmTargets) {
		if ((!useSingleTarget || HostManager.hostIsLinux) && jvmTarget != KonanTarget.LINUX_X64) continue
		if ((!useSingleTarget || HostManager.hostIsMac) && jvmTarget != KonanTarget.MACOS_X64) continue
		if ((!useSingleTarget || HostManager.hostIsMingw) && jvmTarget != KonanTarget.MINGW_X64) continue
